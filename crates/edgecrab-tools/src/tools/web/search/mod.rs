...
pub use config::{
    ...
    clear_web_search_chain_in_config, effective_web_search_config, format_saved_chain_summary,
    format_search_chain_summary, load_web_search_config_from_disk,
    load_web_search_config_from_path, persist_web_search_chain_in_config, web_search_is_available,
};
...
pub use response::{
    build_web_search_agent_notes, format_web_search_result_count, format_web_search_status_line,
    success_payload, summarize_web_search_backend, web_search_result_note,
};
pub use setup::{
    ...
    ensure_web_search_config_coherence, ensure_web_search_config_coherence_at, format_picker_label,
    migrate_legacy_search_override, order_from_primary_and_fallbacks,
    persist_search_backend_as_chain, persist_search_chain_order, persist_search_chain_with_timeout,
    primary_and_fallbacks_from_order, print_provider_detail_cli, provider_detail_lines,
...
pub use web_config::{
    ...
    load_web_tools_config_from_disk, load_web_tools_config_from_path,
    persist_web_backend_in_config, persist_web_section_in_config, resolve_config_extract_backend,
