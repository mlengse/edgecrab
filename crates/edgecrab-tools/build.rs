...
/// Release-only embedding. Debug builds read `skills/` from disk via
/// `skills_sync::bundled_skills_dir()` — skipping embed avoids compiling ~7MB
/// of string literals on every `edgecrab-tools` rebuild.
