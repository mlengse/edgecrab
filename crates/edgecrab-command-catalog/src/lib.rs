...
pub const BUILTIN_SLASH_COMMANDS: &[SlashCommandSpec] = &[
    ...
    SlashCommandSpec {
        name: "hooks",
        aliases: &["hook"],
        description: "Inspect or reload local lifecycle hooks",
        category: "Tools",
        args_hint: "[list|status|help|reload]",
        cli: true,
        gateway: false,
    },
    SlashCommandSpec {
    ...
    SlashCommandSpec {
        ...
        category: "Memory & Skills",
        args_hint: "[list|pending|approve|reject|diff|approval]",
        cli: true,
        gateway: true,
    },
    SlashCommandSpec {
    ...
    SlashCommandSpec {
        ...
        description: "Rescan skills dir and refresh slash commands",
        category: "Memory & Skills",
        args_hint: "",
        cli: true,
        gateway: true,
    ...
    SlashCommandSpec {
        ...
        category: "Advanced",
        args_hint: "[status|pause|resume|clear|<text>]",
        cli: true,
        gateway: true,
    },
    SlashCommandSpec {
    ...
    SlashCommandSpec {
        name: "done",
        aliases: &[],
        description: "Mark the most recent incomplete subgoal done",
        category: "Advanced",
        args_hint: "",
        cli: true,
        gateway: true,
